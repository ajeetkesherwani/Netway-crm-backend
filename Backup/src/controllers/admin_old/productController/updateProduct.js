const Product = require("../../../models_old/products");
...
exports.updateProduct = catchAsync(async (req, res) => {
  try {
    ...
    console.log("winofeeeeeeeeeeeeeeeeeeeeeeeee", variants);
    ...
    // console.log("parsedVariants", Array.isArray(parsedVariants));
    ...
    // product.variants = variants ? parsedVariants : product.variants;
    product.variants = variants ? parsedVariants : product.variants;
