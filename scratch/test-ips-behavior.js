...
function testSoapWithIps(ipsXml, testName) {
  const username = "TESTDYNAMIC" + Math.floor(1000 + Math.random() * 9000);
...
async function runTests() {
  // Test C: <ip>0.0.0.0</ip> and <staticip>0.0.0.0</staticip> with Pool 1
  const testC = `
    <ips xsi:type="tns:ips" SOAP-ENC:arrayType="tns:ip[1]">
      <item xsi:type="tns:ip">
        ...
        <ip xsi:type="xsd:string">0.0.0.0</ip>
        ...
        <staticip xsi:type="xsd:string">0.0.0.0</staticip>
  ...
  `;
  await testSoapWithIps(testC, "Test C: ip=0.0.0.0");

  // Test D: <st_isonpppoe>true</st_isonpppoe> with pool
  const testD = `
    <ips xsi:type="tns:ips" SOAP-ENC:arrayType="tns:ip[1]">
      <item xsi:type="tns:ip">
        <id xsi:type="xsd:integer">0</id>
        ...
        <ip xsi:type="xsd:string">0.0.0.0</ip>
        <st_isweblogin xsi:type="xsd:boolean">false</st_isweblogin>
        <st_isonpppoe xsi:type="xsd:boolean">true</st_isonpppoe>
        <st_onlinemac xsi:type="xsd:string"></st_onlinemac>
        <st_onu xsi:type="xsd:string"></st_onu>
        <disabled xsi:type="xsd:boolean">false</disabled>
  ...
  `;
  await testSoapWithIps(testD, "Test D: st_isonpppoe=true, staticip empty, ip=0.0.0.0");
}
