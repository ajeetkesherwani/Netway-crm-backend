...
exports.getLcoWiseUpcomingRenewalUserDetails = catchAsync(async (req, res) => {
    ...
    plans.forEach((plan) => {
        ...
        // Include if expiryDate is today or in the future
    ...
    // === RESPONSE ===
    return successResponse(res, "LCO-wise upcoming renewal users fetched successfully", {
        lcoId,
        filter,
        year: selectedYear,
