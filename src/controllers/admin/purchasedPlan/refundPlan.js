...
exports.refundPurchasedPlan = catchAsync(async (req, res, next) => {
  try {
    ...
    console.log("refundWalletDoc", refundWalletDoc);
    console.log("refundWalletType", refundWalletType);
    ...
    console.error("Error in refundPurchasedPlan:", error);
    return next(new AppError("An error occurred while processing the refund", 500));
  }
});
