...
exports.getOpenTicketList = catchAsync(async (req, res, next) => {
    // Fetch open tickets
    ...
    successResponse(res, "Open tickets fetched successfully", formattedTickets);
});
